              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-bold">2.1 млн ₸</span>
                  </div>
                  <div className="flex items-center text-blue-200">
                    <span className="mr-4">📍 Алматы</span>
                    <span className="bg-green-600 text-white px-2 py-1 rounded text-xs">Доставлено</span>
                  </div>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-2xl">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-bold">8.7 млн ₸</span>
                  </div>
                  <div className="flex items-center text-blue-200">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {['32×3', '38×4', '57×3', '76×4', '89×4', '108×4', '133×4', '159×4'].map((size) => (
                    <div key={size} className="bg-white/10 backdrop-blur-sm border border-white/20 p-4 rounded-xl text-center">
          ...
          <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-3xl p-8 lg:p-12 text-white">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                <h4 className="text-2xl font-bold mb-6">Популярные размеры:</h4>
                <div className="grid grid-cols-2 gap-4">
                  {['20×20×2', '25×25×2', '30×30×3', '40×40×3', '50×50×4', '60×60×4', '80×80×5', '100×100×6'].map((size) => (
                    <div key={size} className="bg-white/10 backdrop-blur-sm border border-white/20 p-4 rounded-xl text-center">
                      <div className="font-bold text-lg">{size}</div>
